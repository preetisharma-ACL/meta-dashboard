...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside
                class={`fixed top-0 left-0 h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-50 transition-all duration-300 ${isCollapsed() ? 'w-20' : 'w-64'
